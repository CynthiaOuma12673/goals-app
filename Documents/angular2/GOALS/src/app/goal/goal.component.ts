...
export class GoalComponent implements OnInit {
  ...
  new Goal(4,'Get Dog Food','Pupper likes expensive snacks', new Date(2023,1,18)),
  new Goal(5,'Solve math homework','Damn Math', new Date(2023,2,14)),
  new Goal(6,'Plot my world domination plan','Cause I am an evil overlord', new Date(2023,3,14)),
];
